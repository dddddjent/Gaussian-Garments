...
GAUGAR_BUILD="$(dirname "$(dirname "$CONDA_PREFIX")")/build/gaugar"
...
conda install -c conda-forge -y \
  ...
  gcc_linux-64=13 gxx_linux-64=13 ninja cmake ffmpeg \
  'colmap=4.2.0=cuda_130*' 'libopenimageio=3.1.*'
...
export MAX_JOBS=6
export FORCE_CUDA=1
conda env config vars set -n gaugar CUDA_HOME="$CONDA_PREFIX" TORCH_CUDA_ARCH_LIST='8.0;8.6;9.0;12.0'
